...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setColor(getResources().getColor(R.color.green));
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (mOutlinePaint.getColor() != AdvertiseViewPager.sOutlineColor) {
			mOutlinePaint.setColor(AdvertiseViewPager.sOutlineColor);
		}
