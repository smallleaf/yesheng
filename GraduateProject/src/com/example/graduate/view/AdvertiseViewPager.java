package com.example.graduate.view;
...
public class AdvertiseViewPager extends ViewPager{
	...
	public static final String TAG = "AdvertiseViewPager";
	...
	public AdvertiseViewPager(Context context, AttributeSet attrs){
		...
		TypedArray taArray=context.obtainStyledAttributes(attrs,R.styleable.AdvertiseViewPager );
		int effect=taArray.getInt(R.styleable.AdvertiseViewPager_style, 0);
		...
		setFadeEnabled(taArray.getBoolean(R.styleable.AdvertiseViewPager_fadeEnabled,
				false));
		setOutlineEnabled(taArray.getBoolean(
				R.styleable.AdvertiseViewPager_outlineEnabled, false));
		setOutlineColor(taArray.getColor(R.styleable.AdvertiseViewPager_outlineColor,
				Color.WHITE));
