...
public final class NotificationReceiver extends BroadcastReceiver {
    ...
    //    }
/**
 * NotificationReceiver 在接收到NotificationPacketListener 中发出的广播后，
 * 先判断Intent 中携带的动作和自己所收听的动作是否一致，如果一致，则继续从Intent 
 * 中取出Intent 所携带的信息并调用 Notifier 的notify(String notificationId,
 *  String apiKey, String title, String message, String uri) 来发送通知。
 */
    @Override
