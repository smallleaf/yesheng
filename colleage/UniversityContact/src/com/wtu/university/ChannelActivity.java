...
import com.wtu.university.slidingMenu.adapter.DragAdapter;
import com.wtu.university.slidingMenu.adapter.OtherAdapter;
import com.wtu.university.slidingMenu.bean.ChannelItem;
import com.wtu.university.slidingMenu.bean.ChannelManage;
import com.wtu.university.view.DragGrid;
import com.wtu.university.view.OtherGridView;
...
//		    otherChannelList = ((ArrayList<ChannelItem>)ChannelManage.getManage(AppApplication.getApp().getSQLHelper()).getOtherChannel());
		...
		for(int i=0;i<ChannelManage.defaultOtherChannels.size();i++){
			otherChannelList.add(ChannelManage.defaultOtherChannels.get(i));
		}
	...
	private void saveChannel() {
		...
		ChannelManage.defaultOtherChannels=otherAdapter.getChannnelLst();
		ChannelManage.defaultUserChannels.clear();
		ChannelManage.defaultUserChannels=userAdapter.getChannnelLst();
