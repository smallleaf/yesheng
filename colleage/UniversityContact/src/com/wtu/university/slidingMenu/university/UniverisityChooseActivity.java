...
public class UniverisityChooseActivity extends BaseActivity {
	...
	private void init() {
		...
		mListView.setOnChildClickListener(new OnChildClickListener(){
			...
			public boolean onChildClick(ExpandableListView arg0, View arg1,
				...
				// TODO Auto-generated method stub
				editor.putString(Constants.SP_UNIVERISTY_CHOOSE, university[groupPosition][childPosition]);
				editor.commit();
				Intent intent = new Intent(getApplicationContext(), MainInterfaceActivity.class);
				setResult(MainInterfaceActivity.UNIVERISYCHOOSE, intent);
				finish();
				return true;
			}
