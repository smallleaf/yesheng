...
public class ImageUtils {
	...
	public static Uri createImagePathUri(Context context) {
		...
		if (status.equals(Environment.MEDIA_MOUNTED)) {// 判断是否有SD�?优先使用SD卡存�?当没有SD卡时使用手机存储
	...
	public static void cropImage(Activity activity, Uri uri) {
		...
		//	会以裁剪框的宽为�?按照裁剪宽高比例生成�?��图片,该图和框选部分可能不�?
		//  不同的情况可能是截取框�?的一部分,也可能超出框选部�?向下延伸补足
		////////////////////////////////////////////////////////////////
